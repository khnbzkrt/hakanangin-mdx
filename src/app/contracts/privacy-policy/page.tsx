const PrivacyPolicy = () => {
    return (
        <div>
            ...
            <p>
                Biz, hakanangin.com, veri sorumlusu olarak, bu gizlilik ve kişisel verilerin korunması politikası ile,
                hangi kişisel verilerinizin hangi amaçla işleneceği, işlenen verilerin kimlerle ve neden
            ...
            <p>
                ...
                makamlarla paylaşılması) yerine getirilebilmesi amacıyla, sözleşme ve hizmet süresince, amacına uygun ve
            ...
            <p>
                ...
                dışındaki 3. şahıslar ile kurum ve kuruluşlara ve talep halinde adli ve idari makamlara, gerekli teknik
                ve idari önlemler alınması koşulu ile aktarılabilecektir.
            </p>
            ...
            <p>
                Yukarıda sayılan haklarınızı kullanmak üzere dev.hakanangin@gmail.com üzerinden bizimle iletişime
                geçebilirsiniz.
            </p>
            <h2>İletişim</h2>
            <p>
                ...
                tarafımızca varsayılacak olup, daha ayrıntılı bilgi için bizimle dev.hakanangin@gmail.com e-mail adresi
